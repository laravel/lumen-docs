...
Lumen 5.2 represents a more decided shift towards focusing on stateless APIs. Therefore, sessions and views have been removed from the framework. If you would like to use these features, you should uprade your Lumen 5.1 application to Laravel 5.2.
