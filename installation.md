...
Of course, when using [Homestead](http://laravel.com/docs/homestead) or  [Docker-Lumen](https://github.com/saada/docker-compose-lumen), pretty URLs will be configured automatically.
